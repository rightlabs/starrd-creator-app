  ...
  <div className="flex items-center justify-between pt-6 relative">
    ...
    >
      SKIP
        ...
        >
          <div>
            <h1 className="text-4xl font-extrabold mb-2">Connect your socials</h1>
            <p className="text-black/60">Your follower count will be displayed on your profile. Your analytics will integrate into the creator tools.</p>
          </div>

          {/* Social Buttons */}
          <div className="space-y-4">
            <motion.div 
              className="p-4 bg-black rounded-2xl flex items-center justify-between"
